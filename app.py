...
def open_browser():
    """Opens the web browser automatically after Flask starts"""
...
if __name__ == '__main__':
    ...
    print("\n" + "="*60)
    print(" Starting ABC X1 Smartwatch Sentiment Analyzer...")
    print("="*60)
    print(" The browser will open automatically in a moment!")
    print(" If it doesn't, manually visit: http://127.0.0.1:5001")
    print("="*60 + "\n")
